...
class DisposisiResource extends Resource
{
    ...
    /**
     * Non-admin tidak perlu melihat disposisi tembusan sebagai "tugas".
     */
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\Filter::make('disposisi_saya')
                    ...
                    ->query(
                        ...
                        $query->where('ke_user_id', \Illuminate\Support\Facades\Auth::id())
                    ),
                Tables\Filters\Filter::make('disposisi_dari_saya')
                    ...
                    ->query(
                        fn(Builder $query): Builder =>
                        $query->where('dari_user_id', \Illuminate\Support\Facades\Auth::id())
                    ),
            ...
            ->actions([
                \Filament\Actions\Action::make('prosesDisposisi')
                    ...
                    ->visible(fn(Disposisi $record) => ! $record->is_tembusan && $record->status === 'belum_diproses'),
                \Filament\Actions\Action::make('selesaiDisposisi')
                    ...
                    ->visible(fn(Disposisi $record) => ! $record->is_tembusan && $record->status === 'sedang_diproses'),
                \Filament\Actions\Action::make('teruskanDisposisi')
                    ...
                    ->visible(fn(Disposisi $record) => ! $record->is_tembusan && $record->status !== 'selesai'),
